...
var IconsService = class _IconsService {
  ...
  constructor(_iconSettings, iconSettingsService) {
    ...
    if (iconSettingsService) {
      this.subs.add(iconSettingsService.changes.pipe((0, import_operators.map)((iconSettings) => isPresent2(iconSettings) ? iconSettings : this._iconSettings), (0, import_operators.tap)((iconSettings) => this._iconSettings = iconSettings)).subscribe((iconSettings) => this.changes.next(iconSettings)));
    }
    if (isPresent2(this.iconSettings) && !this.areSettingsEqual()) {
...
var ResizeService = class _ResizeService {
  ...
  subscribe(callback) {
    ...
    this._zone.runOutsideAngular(() => {
      this.subscription = (0, import_rxjs2.fromEvent)(this._dom.getWindow(), "resize").pipe((0, import_operators2.auditTime)(FRAME_DURATION)).subscribe(() => callback());
    });
  }
  unsubscribe() {
...
var ScrollableService = class _ScrollableService {
  ...
  subscribe(callback) {
    ...
    this._zone.runOutsideAngular(() => {
      const observables = parents.map((p) => (0, import_rxjs2.fromEvent)(p, "scroll").pipe((0, import_operators2.auditTime)(FRAME_DURATION)));
      const subscriber = (e) => {
      ...
      this.subscription = (0, import_rxjs2.merge)(...observables).subscribe(subscriber);
    });
  }
  unsubscribe() {
    if (!this.subscription) {
...
var PopupComponent = class _PopupComponent {
  ...
  ngAfterViewChecked() {
    ...
    this._zone.runOutsideAngular(() => {
      ...
      this.repositionSubscription = (0, import_rxjs2.from)(this.resolvedPromise).subscribe(this.reposition);
    });
  }
  ngOnDestroy() {
...
var KendoButtonService = class _KendoButtonService {
  buttonClicked = new import_rxjs3.Subject();
...
var ButtonComponent = class _ButtonComponent {
  ...
  direction;
  _selected;
  subs = new import_rxjs3.Subscription();
  _iconClass;
  _icon;
  _svgIcon;
...
var ButtonGroupComponent = class _ButtonGroupComponent {
  ...
  ngOnInit() {
    ...
    this.subs.add((0, import_rxjs3.fromEvent)(this.element.nativeElement, "focusout").pipe((0, import_operators3.filter)((event) => this.navigable && event.relatedTarget && event.relatedTarget.parentNode !== this.element.nativeElement)).subscribe(() => {
      this.defocus(this.buttons.toArray());
      this.currentTabIndex = this.tabIndex;
    }));
  }
  ...
  handleSubs(eventName, predicate, handler) {
    this.subs.add((0, import_rxjs3.fromEvent)(this.element.nativeElement, eventName).pipe((0, import_operators3.filter)(predicate)).subscribe(handler));
  }
  focusHandler = () => {
    this.currentTabIndex = -1;
    this.defocus(this.buttons.toArray());
...
var ListButton = class _ListButton extends MultiTabStop {
  ...
  direction;
  popupRef;
  popupSubs = new import_rxjs3.Subscription();
  button;
  buttonList;
  popupTemplate;
  container;
  ...
  subscribeComponentBlurredEvent() {
    this._zone.runOutsideAngular(() => {
      this.subs.add(this.navigationService.tab.pipe((0, import_operators3.filter)(() => this._isFocused), (0, import_operators3.tap)(() => this.focusButton())).subscribe(this.handleTab.bind(this)));
      this.subs.add((0, import_rxjs3.fromEvent)(document, "click").pipe((0, import_operators3.filter)((event) => !this.wrapperContains(event.target)), (0, import_operators3.filter)(() => this._isFocused)).subscribe(() => this._zone.run(() => this.blurWrapper())));
    });
  }
  subscribeNavigationEvents() {
    ...
    this.subs.add((0, import_rxjs3.merge)(this.navigationService.close, this.navigationService.esc).subscribe(this.onNavigationClose.bind(this)));
  }
  /**
...
var DialListComponent = class _DialListComponent {
  ...
  dialItemTemplate;
  align;
  subscriptions = new import_rxjs3.Subscription();
...
var FloatingActionButtonComponent = class _FloatingActionButtonComponent {
  ...
  subscribeNavigationEvents() {
    ...
    this.subscriptions.add((0, import_rxjs3.merge)(this.navigationService.close, this.navigationService.esc).subscribe(this.onNavigationClose.bind(this)));
  }
  onArrowKeyNavigate({
    index
  }) {
  ...
  closeDial() {
    if (this.dialItemAnimation && this.isValidAnimation()) {
      ...
      this.animationEnd.pipe((0, import_operators3.take)(1)).subscribe(() => this.closePopup());
    } else {
      this.closePopup();
    }
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_BUTTONS_FESM2022_PROGRESS_KENDO_ANGULAR_BUTTONS_MJS_0 = goog.getMsg("{$interpolation}", {
          "interpolation": "�0�"
        }, {
          original_code: {
        ...
        i18n_0 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_BUTTONS_FESM2022_PROGRESS_KENDO_ANGULAR_BUTTONS_MJS_0;
      } else {
...
//# sourceMappingURL=chunk-PFBKF7L7.js.map
