  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_0 = goog.getMsg("Close");
        i18n_0 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_0;
      } else {
...
var DialogComponent = class _DialogComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_1 = goog.getMsg("Close");
        i18n_1 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_1;
      } else {
...
See https://www.telerik.com/kendo-angular-ui/components/dialogs/dialog/service/.
  ...
  initializeDialog(component, factory, container, dialogRef, options) {
    ...
    const result = (0, import_rxjs.merge)(
      ...
      (0, import_rxjs.merge)(dialog.instance.close, dialog.instance.action).pipe((0, import_operators.map)((e) => e instanceof PreventableEvent ? new DialogCloseResult() : e), (0, import_operators.filter)((e) => {
...
var DragResizeService = class _DragResizeService {
  ...
  dragSubscription = new import_rxjs.Subscription();
  constructor(ngZone) {
    this.ngZone = ngZone;
  }
  ngOnDestroy() {
...
var WindowComponent = class _WindowComponent {
  ...
  draged = false;
  resized = false;
  windowSubscription = new import_rxjs.Subscription();
  domSubs = new import_rxjs.Subscription();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_2 = goog.getMsg("Close");
        i18n_2 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_2;
      } else {
        i18n_2 = $localize`:kendo.window.closeTitle|The title of the close button:Close`;
      }
      let i18n_3;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_3 = goog.getMsg("Restore");
        i18n_3 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_3;
      } else {
        i18n_3 = $localize`:kendo.window.restoreTitle|The title of the restore button:Restore`;
      }
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_4 = goog.getMsg("Maximize");
        i18n_4 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_4;
      } else {
        i18n_4 = $localize`:kendo.window.maximizeTitle|The title of the maximize button:Maximize`;
      }
      let i18n_5;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_5 = goog.getMsg("Minimize");
        i18n_5 = MSG_C__USERS_KRYST_RIDERPROJECTS_OPTISCHEDROOT_OPTISCHED_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2022_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_5;
      } else {
...
//# sourceMappingURL=chunk-5D744XNO.js.map
